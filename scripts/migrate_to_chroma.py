...
def main():
    ...
    parser.add_argument("--old-index", default=str(Path.home() / ".docchat" / "index.pkl"), help="Đường dẫn file index.pkl cũ")
    parser.add_argument("--embedder", default="openai", choices=["local", "openai"], help="Cơ chế nhúng (Embedder) sử dụng lại để re-embed")
    ...
    try:
        ...
        print("Lưu ý: Index cũ vẫn được giữ nguyên. Hãy xoá file index.pkl thủ công nếu không cần dùng tới.")
        return 0
    except Exception as e:
